...
public class SoftAssertLogic {
    ...
    public void softAssert(){
        SoftAssert softAssert = new SoftAssert(); //softAssert is the class
        ...
        softAssert.assertAll();//it is telling you what is not working but code still run
        //even result is wrong , code will still pass
    }
}
